...
--
-- Host: localhost
-- Waktu pembuatan: 30 Bulan Mei 2021 pada 16.24
...
(1, 'Muh. Adhan', 'Operator Mesin Cutting', 15, 1),
(2, 'Bambang Sugiyono', 'Operator Komputer', 20, 1),
(3, 'Adam Bilal', 'Programmer', 35, 1),
(7, 'Fikri Zainudin', 'Crew Smelter', 20, 1),
(11, 'Aldi Ridho Poho', 'Operator Forklift Crain', 10, 1),
(13, 'Husein Batubara', 'Crew Smelter', 0, 1);
...
INSERT INTO `data` (`id`, `pembayaran`) VALUES
(1, 10000000);
...
(14, 'member', 'member@gmail.com', 'default.jpg', '$2y$10$X8ghecjNnUmHlU.8SzHWw.jlZQiaHjusw7hzUJ40vKQQ9vmiqAoVC', 2, 1, 1622391825);

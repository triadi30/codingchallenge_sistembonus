            ...
            <form method="POST" action="<?= base_url('user/update_pembayaran') ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5 ml-3">
                        <input type="text" disabled class="form-control-plaintext text-center" name="pembayaran" value="<?= $pembayaran; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="buruh" class="col-sm-2 col-form-label"><?= $buruh1['nama']; ?></label>
                    <div class="col-sm-5 ml-3">
                        <input type="text" disabled class="form-control text-center" name="buruhA" id="buruhA" placeholder="Persentase Bonus" value="<?= $buruhA; ?>">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5 ml-3">
                        <input type="text" disabled class="form-control text-center" name="buruhB" id="buruhB" placeholder="Persentase Bonus" value="<?= $buruhB; ?>">
                    </div>
                    <div class="col-sm-3">%</div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-5 ml-3">
                        <input type="text" disabled class="form-control text-center" name="buruhC" id="buruhC" placeholder="Persentase Bonus" value="<?= $buruhC; ?>">
                    </div>
                    <div class="col-sm-3">%</div>
                </div>
            </form>
